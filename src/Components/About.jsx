...
function About() {
  ...
  return (
    ...
    <div className="accordion-item">
        ...
        <div id="collapseOne" style={style} className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
    ...
    <div className="accordion-item">
        ...
        <div id="collapseTwo" style={style} className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
        <div className="accordion-body">
    ...
    <div className="accordion-item">
        ...
        <div id="collapseThree" style={style} className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
        <div className="accordion-body">
    ...
    <button type="button" onClick={toggleMode} className="btn btn-primary">{textMode}</button>
    </div>
    </div>
    </>
  )
